...
**Always research the codebase before making changes.**

- Use the `samplecode-researcher` agent (defined at [.claude/agents/samplecode-researcher.md](.claude/agents/samplecode-researcher.md)) to inspect, search, or extract information from files in `D:\KudoFlow\Samplecode`.
...
```
D:\KudoFlow\
├── extension\     Chrome extension (KudoToolAI) — file chính để edit
├── server\        Node.js backend API
├── Samplecode\    Reference code cho agents
└── CLAUDE.md      File này
```

- Extension entry: `extension\sidebar.html`, `extension\background.js`
