const LOCAL_BUILT_IN_TEMPLATES = [
  ...
  },
  {
    ...
    description: 'Upload ảnh sản phẩm → AI viết prompt → sinh 1 ảnh collage 4 góc nhìn → dùng làm ref cho model UGC mặc sản phẩm.',
    category_name: 'UGC / Marketing',
    is_premium: false,
    use_count: 0,
    ...
    nodes: [
      ...
      // --- AI: phân tích + viết collage prompt ---
      {
        ...
        slug: 'collage_prompt',
        slug_auto: false,
        prompt: 'You are a fashion image director. Analyze this outfit reference image carefully.\n\nWrite an image generation prompt for Google Flow that creates a professional fashion editorial contact sheet.\n\nThe output must be a contact sheet image with 6 panels in a 3-column × 2-row grid layout, separated by thin white borders, neutral warm gray studio background (#b8a99a), soft professional lighting.\n\nPanel structure:\n• TOP-LEFT: Label "OVERVIEW: FRONT COMPOSITION" — full-body front view, complete styled outfit\n• TOP-CENTER: Label "OVERVIEW: PROFILE PRESENTATION" — full-body 3/4 side angle\n• TOP-RIGHT: Label "DETAIL: [specific fabric/texture name]" — extreme close-up of the hero garment\'s fabric or embellishment\n• BOTTOM-LEFT: Label "DETAIL: [specific footwear name]" — close-up of shoes/heels/boots\n• BOTTOM-CENTER: Label "DETAIL: [specific accessory]" — if no bag visible, use neckline/collar detail or a complementary accessory that matches the outfit\n• BOTTOM-RIGHT: Label "DETAIL: [specific styling element]" — flat-lay of small accessories (earrings, belt, brooch) or fabric texture close-up\n\nCRITICAL RULES:\n- NEVER use brackets [ ] in the final output — always replace with real specific names\n- If an element is not visible in the reference (e.g. no bag), describe a detail that complements the outfit\n- Panel labels must be white uppercase text, small font, top-left corner of each panel\n\nReturn ONLY the image generation prompt in English. Start with: "Commercial fashion product photography contact sheet,".',
        prompt_mode: 'all',
        use_ai: true,
        provider: 'gemini',
    ...
    edges: [
      ...
      // Collage → Download
      { edge_id: 'local_fpp_e7', source_node_id: 'local_fpp_n3', target_node_id: 'local_fpp_n7', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'media_in', data_type: 'image' },
      // Model → Download
      { edge_id: 'local_fpp_e8', source_node_id: 'local_fpp_n6', target_node_id: 'local_fpp_n7', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'media_in', data_type: 'image' },
    ],
  },
  {
    id: 'local_avatar_product_video',
    is_local: true,
    name: 'Avatar wears Product → Video',
    description: 'Upload ảnh sản phẩm + ảnh avatar → AI viết prompt → tạo 1 ảnh model mặc sản phẩm → AI viết video motion → tạo video 6s showcase sản phẩm.',
    category_name: 'UGC / Marketing',
    is_premium: false,
    use_count: 0,
    settings: { parallel: false, quantity: 1 },
    nodes: [
      ...
      {
        node_id: 'local_apv_n3',
        node_type: 'prompt',
        node_name: 'AI Support',
        slug: 'avatar_product_prompt',
        slug_auto: false,
        prompt: 'You have two reference images:\n① PRODUCT — a fashion garment (analyze: exact fabric, color, texture, cut, details)\n② AVATAR — a model (analyze: face, skin tone, hair, body proportions — must be preserved exactly)\n\nWrite a single image generation prompt for Google Flow.\n\nThe prompt must describe:\n- The AVATAR model wearing the PRODUCT garment (every garment detail must match exactly)\n- The model\'s face, skin tone, hair, and body proportions must be identical to the AVATAR reference — do not alter any facial features\n- ONE natural background that complements the garment style (choose based on the outfit: e.g. soft studio, garden, architecture, street — pick the most fitting one)\n- Professional fashion editorial lighting, full-body shot\n- 4K resolution, ultrasharp, highly detailed\n\nReturn ONLY the image prompt in English. No explanation, no labels, no options.\nStart directly with the subject description.',
        prompt_mode: 'all',
        use_ai: true,
        provider: 'gemini',
        ai_delete_after_run: true,
      ...
      {
        node_id: 'local_apv_n4',
        node_type: 'generate',
        node_name: 'Tạo ảnh/video',
        prompt: '@avatar_product_prompt',
        prompt_mode: 'mention',
        ref_mode: 'all',
        media_type: 'Image',
        ratio: '9:16',
      ...
      {
        node_id: 'local_apv_n5',
        node_type: 'prompt',
        node_name: 'AI Agent',
        slug: 'video_motion_prompt',
        slug_auto: false,
        prompt: 'Look at this fashion photo. Write a short video motion prompt (English only, plain text, no headers).\n\nRequirements:\n- Model does subtle poses: slow fabric sway, gentle twirl, hand adjusts dress\n- No talking, no expression changes, silent showcase\n- Camera fully static — no pan, no zoom, no movement at all\n- Soft consistent lighting, 4K ultrasharp\n- 6 seconds duration\n\nOutput: one paragraph, start with the action description directly.',
        prompt_mode: 'all',
        use_ai: true,
        provider: 'gemini',
        ai_delete_after_run: true,
      ...
      {
        node_id: 'local_apv_n6',
        node_type: 'generate',
        node_name: 'Tạo ảnh/Video 2',
        ...
        ratio: '9:16',
        quantity: 1,
        pos_x: 1420, pos_y: 300,
        enabled: true,
      },
      {
        node_id: 'local_apv_n7',
        node_type: 'download',
        node_name: 'Tải kết quả',
        download_resolution: '1k',
        pos_x: 1740, pos_y: 300,
        enabled: true,
      },
    ],
    edges: [
      // Product + Avatar → AI Support
      { edge_id: 'local_apv_e1', source_node_id: 'local_apv_n1', target_node_id: 'local_apv_n3', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      { edge_id: 'local_apv_e2', source_node_id: 'local_apv_n2', target_node_id: 'local_apv_n3', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      // AI Support text → Generate image
      { edge_id: 'local_apv_e3', source_node_id: 'local_apv_n3', target_node_id: 'local_apv_n4', source_handle: 'output_1', target_handle: 'input_2', source_port: 'text', target_port: 'text', data_type: 'text' },
      // Product + Avatar → Generate image (image ref cho Google Flow)
      { edge_id: 'local_apv_e4', source_node_id: 'local_apv_n1', target_node_id: 'local_apv_n4', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      { edge_id: 'local_apv_e5', source_node_id: 'local_apv_n2', target_node_id: 'local_apv_n4', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      // Generated image → AI Agent video
      { edge_id: 'local_apv_e6', source_node_id: 'local_apv_n4', target_node_id: 'local_apv_n5', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      // AI Agent text → Generate video
      { edge_id: 'local_apv_e7', source_node_id: 'local_apv_n5', target_node_id: 'local_apv_n6', source_handle: 'output_1', target_handle: 'input_2', source_port: 'text', target_port: 'text', data_type: 'text' },
      // Generated image → Generate video (image ref)
      { edge_id: 'local_apv_e8', source_node_id: 'local_apv_n4', target_node_id: 'local_apv_n6', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      // Video → Download
      { edge_id: 'local_apv_e9', source_node_id: 'local_apv_n6', target_node_id: 'local_apv_n7', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'media_in', data_type: 'video' },
    ],
  },
  {
    id: 'local_ugc_pose',
