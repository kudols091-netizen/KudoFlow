const LOCAL_BUILT_IN_TEMPLATES = [
  {
    id: 'local_fashion_video',
    is_local: true,
    name: 'Fashion AI Video',
    description: 'Tạo 3 pose ảnh fashion cho nhân vật + sản phẩm → tự động sinh 3 video clip riêng lẻ bằng VEO 3. Upload ảnh nhân vật + ảnh sản phẩm → chỉnh prompt → chạy.',
    ...
    nodes: [
      ...
      },
      {
        ...
        slug: 'fashion_desc',
        slug_auto: false,
        prompt: 'Young Asian woman, natural makeup, professional fashion photography, clean white background',
        prompt_mode: 'all',
        pos_x: 80, pos_y: 680,
        enabled: true,
      },
      // --- Image gen layer ---
      {
        ...
        prompt: '@fashion_desc, standing straight, confident smile, full body shot, wearing the product',
        prompt_mode: 'mention',
        ref_mode: 'all',
        media_type: 'Image',
        ratio: '9:16',
      ...
      },
      {
        ...
        prompt: '@fashion_desc, sitting casually, relaxed lifestyle pose, soft blurred background, wearing the product',
        prompt_mode: 'mention',
        ref_mode: 'all',
        media_type: 'Image',
        ratio: '9:16',
      ...
      },
      {
        ...
        prompt: '@fashion_desc, holding product toward camera, UGC showcase style, warm studio lighting',
        prompt_mode: 'mention',
        ref_mode: 'all',
        media_type: 'Image',
        ratio: '9:16',
      ...
      // --- Video prompt ---
      {
        node_id: 'local_fv_n7',
        node_type: 'text',
        node_name: 'Video Motion Prompt',
        slug: 'video_motion',
        slug_auto: false,
        prompt: 'model walks forward slowly, hair flows gently, fabric moves naturally, cinematic fashion editorial, soft studio lighting, smooth camera push-in',
        prompt_mode: 'all',
        pos_x: 800, pos_y: 380,
        enabled: true,
      },
      // --- Video gen layer (VEO 3) ---
      {
        node_id: 'local_fv_n8',
        node_type: 'generate',
        node_name: 'Video: Đứng thẳng',
        prompt: '@video_motion',
        prompt_mode: 'mention',
        ref_mode: 'all',
        media_type: 'Video',
      ...
      },
      {
        ...
        ratio: '9:16',
        quantity: 1,
        pos_x: 1140, pos_y: 380,
        enabled: true,
      },
      {
        node_id: 'local_fv_n10',
        node_type: 'generate',
        node_name: 'Video: Cầm sản phẩm',
        prompt: '@video_motion',
        prompt_mode: 'mention',
        ref_mode: 'all',
        media_type: 'Video',
        ...
        ratio: '9:16',
        quantity: 1,
        pos_x: 1140, pos_y: 680,
        enabled: true,
      },
      // --- Output ---
      {
        node_id: 'local_fv_n11',
        node_type: 'download',
        node_name: 'Tải kết quả',
        download_resolution: '1k',
        pos_x: 1460, pos_y: 380,
        enabled: true,
      },
    ],
    edges: [
      // Avatar → 3 Image gen nodes
      { edge_id: 'local_fv_e1', source_node_id: 'local_fv_n1', target_node_id: 'local_fv_n4', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      { edge_id: 'local_fv_e2', source_node_id: 'local_fv_n1', target_node_id: 'local_fv_n5', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      { edge_id: 'local_fv_e3', source_node_id: 'local_fv_n1', target_node_id: 'local_fv_n6', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      // Product → 3 Image gen nodes
      { edge_id: 'local_fv_e4', source_node_id: 'local_fv_n2', target_node_id: 'local_fv_n4', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      { edge_id: 'local_fv_e5', source_node_id: 'local_fv_n2', target_node_id: 'local_fv_n5', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      { edge_id: 'local_fv_e6', source_node_id: 'local_fv_n2', target_node_id: 'local_fv_n6', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      // Mô tả nhân vật → 3 Image gen nodes
      { edge_id: 'local_fv_e7', source_node_id: 'local_fv_n3', target_node_id: 'local_fv_n4', source_handle: 'output_1', target_handle: 'input_2', source_port: 'text', target_port: 'text', data_type: 'text' },
      { edge_id: 'local_fv_e8', source_node_id: 'local_fv_n3', target_node_id: 'local_fv_n5', source_handle: 'output_1', target_handle: 'input_2', source_port: 'text', target_port: 'text', data_type: 'text' },
      { edge_id: 'local_fv_e9', source_node_id: 'local_fv_n3', target_node_id: 'local_fv_n6', source_handle: 'output_1', target_handle: 'input_2', source_port: 'text', target_port: 'text', data_type: 'text' },
      // Image gen → Video gen (1-to-1)
      { edge_id: 'local_fv_e10', source_node_id: 'local_fv_n4', target_node_id: 'local_fv_n8', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      { edge_id: 'local_fv_e11', source_node_id: 'local_fv_n5', target_node_id: 'local_fv_n9', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      { edge_id: 'local_fv_e12', source_node_id: 'local_fv_n6', target_node_id: 'local_fv_n10', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      // Video Motion Prompt → 3 Video gen nodes
      { edge_id: 'local_fv_e13', source_node_id: 'local_fv_n7', target_node_id: 'local_fv_n8', source_handle: 'output_1', target_handle: 'input_2', source_port: 'text', target_port: 'text', data_type: 'text' },
      { edge_id: 'local_fv_e14', source_node_id: 'local_fv_n7', target_node_id: 'local_fv_n9', source_handle: 'output_1', target_handle: 'input_2', source_port: 'text', target_port: 'text', data_type: 'text' },
      { edge_id: 'local_fv_e15', source_node_id: 'local_fv_n7', target_node_id: 'local_fv_n10', source_handle: 'output_1', target_handle: 'input_2', source_port: 'text', target_port: 'text', data_type: 'text' },
      // Video gen → Download
      { edge_id: 'local_fv_e16', source_node_id: 'local_fv_n8', target_node_id: 'local_fv_n11', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'media_in', data_type: 'video' },
      { edge_id: 'local_fv_e17', source_node_id: 'local_fv_n9', target_node_id: 'local_fv_n11', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'media_in', data_type: 'video' },
      { edge_id: 'local_fv_e18', source_node_id: 'local_fv_n10', target_node_id: 'local_fv_n11', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'media_in', data_type: 'video' },
    ],
  },
  {
    id: 'local_fashion_product_photo',
    is_local: true,
    name: 'Fashion Product Photo',
    description: 'Upload ảnh sản phẩm → AI phân tích → sinh 4 loại ảnh: cận chất, flat lay, chi tiết, lifestyle + ảnh model mặc sản phẩm.',
    category_name: 'UGC / Marketing',
    is_premium: false,
    use_count: 0,
    settings: { parallel: false, quantity: 1 },
    nodes: [
      // --- Input ---
      {
        node_id: 'local_fpp_n1',
        node_type: 'image',
        node_name: 'Product Image',
        pos_x: 80, pos_y: 380,
        enabled: true,
      ...
      // --- AI Analysis ---
      {
        node_id: 'local_fpp_n2',
        node_type: 'prompt',
        node_name: 'Phân tích sản phẩm',
        slug: 'product_analysis',
        slug_auto: false,
        prompt: 'Phân tích ảnh sản phẩm thời trang này và trả về JSON với các trường:\n- fabric: chất liệu vải chính xác (VD: 100% linen, silk chiffon, cotton twill...)\n- color: mã màu mô tả chi tiết (VD: warm ivory, dusty sage green...)\n- style: kiểu dáng sản phẩm (VD: A-line midi dress, oversized blazer...)\n- key_details: 3-4 chi tiết nổi bật (VD: pleated front, contrast stitching, mother-of-pearl buttons...)\n- texture_description: mô tả kết cấu bề mặt vải (VD: soft matte, subtle sheen, visible weave pattern...)\n\nChỉ trả về JSON, không giải thích thêm.',
        prompt_mode: 'all',
        use_ai: true,
        provider: 'gemini',
      ...
      // --- Prompt nodes (1 AI + 3 fixed text) ---
      {
        node_id: 'local_fpp_n3',
        node_type: 'prompt',
        node_name: 'Prompt: Cận chất liệu',
        slug: 'gen_prompt',
        slug_auto: false,
        prompt: 'Dựa vào phân tích sản phẩm sau:\n@product_analysis\n\nViết 1 prompt tiếng Anh để tạo ảnh CLOSE-UP MACRO về chất liệu vải. Yêu cầu:\n- Cận cảnh kết cấu vải, sợi dệt, họa tiết bề mặt — không thấy toàn sản phẩm\n- Ánh sáng: soft diffused light thể hiện độ dày và texture\n- Background: clean white/cream\n- Dưới 80 từ, chỉ trả về prompt.',
        prompt_mode: 'all',
        use_ai: true,
        provider: 'gemini',
        ai_delete_after_run: true,
      ...
      {
        node_id: 'local_fpp_n3b',
        node_type: 'text',
        node_name: 'Prompt: Flat lay toàn thân',
        slug: 'flatlay_prompt',
        slug_auto: false,
        prompt: 'Full body flat lay fashion photography of the garment from the reference image. Complete product visible from above, clean white background, bird\'s eye view, symmetrically arranged, soft diffused studio lighting. High-end editorial style, professional product photography. No text, no watermark, no logo, no brand name, no people.',
        prompt_mode: 'all',
        pos_x: 700, pos_y: 280,
        enabled: true,
      },
      {
        node_id: 'local_fpp_n3c',
        node_type: 'text',
        node_name: 'Prompt: Chi tiết đặc biệt',
        slug: 'detail_prompt',
        slug_auto: false,
        prompt: 'Extreme close-up macro photography of a special design detail on the fashion garment from the reference image. Focus on collar, buttons, embroidery, decorative stitching or signature design elements. Razor-sharp focus, white background, soft box lighting. Editorial magazine quality. No text, no watermark, no logo, no brand name, no people.',
        prompt_mode: 'all',
        pos_x: 700, pos_y: 480,
        enabled: true,
      },
      {
        node_id: 'local_fpp_n3d',
        node_type: 'text',
        node_name: 'Prompt: Lifestyle display',
        slug: 'lifestyle_prompt',
        slug_auto: false,
        prompt: 'Fashion product display photography. The garment from the reference image elegantly folded or on a white wooden hanger, minimalist lifestyle composition, soft natural light, clean neutral background. Editorial aesthetic, aspirational mood, high-end boutique feel. No text, no watermark, no logo, no brand name, no people.',
        prompt_mode: 'all',
        pos_x: 700, pos_y: 680,
        enabled: true,
      },
      // --- 4 Generate nodes ---
      {
        node_id: 'local_fpp_n4',
        node_type: 'generate',
        node_name: '① Cận chất liệu',
        prompt: '@gen_prompt, no text, no watermark, no logo, no brand name, no people',
        prompt_mode: 'mention',
        ref_mode: 'all',
        media_type: 'Image',
        ratio: '1:1',
      ...
      {
        node_id: 'local_fpp_n4b',
        node_type: 'generate',
        node_name: '② Flat lay toàn thân',
        ...
        ratio: '1:1',
        quantity: 1,
        pos_x: 1020, pos_y: 280,
        enabled: true,
      },
      {
        node_id: 'local_fpp_n4c',
        node_type: 'generate',
        node_name: '③ Chi tiết đặc biệt',
        ...
        ratio: '1:1',
        quantity: 1,
        pos_x: 1020, pos_y: 480,
        enabled: true,
      },
      {
        node_id: 'local_fpp_n4d',
        node_type: 'generate',
        node_name: '④ Lifestyle display',
        ...
        ratio: '1:1',
        quantity: 1,
        pos_x: 1020, pos_y: 680,
        enabled: true,
      },
      // --- Avatar branch ---
      {
        node_id: 'local_fpp_n6',
        node_type: 'image',
        node_name: 'Avatar Model',
        pos_x: 80, pos_y: 900,
        enabled: true,
      },
      {
        node_id: 'local_fpp_n7',
        node_type: 'text',
        node_name: 'Model Prompt',
        slug: 'model_prompt',
        slug_auto: false,
        prompt: 'Fashion editorial photography, model wearing the product from the reference image, full body shot, clean white studio background, soft professional lighting, natural makeup, confident elegant pose, high-end fashion magazine quality, no text, no watermark, no logo, no brand name',
        prompt_mode: 'all',
        pos_x: 700, pos_y: 900,
        enabled: true,
      },
      {
        node_id: 'local_fpp_n8',
        node_type: 'generate',
        node_name: '⑤ Model mặc sản phẩm',
        prompt: '@model_prompt',
        prompt_mode: 'mention',
        ref_mode: 'all',
        media_type: 'Image',
        ratio: '9:16',
        quantity: 1,
        pos_x: 1020, pos_y: 900,
        enabled: true,
      },
      // --- Output ---
      {
        node_id: 'local_fpp_n5',
        node_type: 'download',
        node_name: 'Tải kết quả',
        download_resolution: '1k',
        pos_x: 1340, pos_y: 480,
        enabled: true,
      },
    ],
    edges: [
      ...
      // AI Analysis → Viết prompt cận chất
      { edge_id: 'local_fpp_e2', source_node_id: 'local_fpp_n2', target_node_id: 'local_fpp_n3', source_handle: 'output_1', target_handle: 'input_1', source_port: 'text', target_port: 'text', data_type: 'text' },
      // Prompts → Generate nodes (text)
      { edge_id: 'local_fpp_e3', source_node_id: 'local_fpp_n3', target_node_id: 'local_fpp_n4', source_handle: 'output_1', target_handle: 'input_2', source_port: 'text', target_port: 'text', data_type: 'text' },
      { edge_id: 'local_fpp_e6', source_node_id: 'local_fpp_n3b', target_node_id: 'local_fpp_n4b', source_handle: 'output_1', target_handle: 'input_2', source_port: 'text', target_port: 'text', data_type: 'text' },
      { edge_id: 'local_fpp_e7', source_node_id: 'local_fpp_n3c', target_node_id: 'local_fpp_n4c', source_handle: 'output_1', target_handle: 'input_2', source_port: 'text', target_port: 'text', data_type: 'text' },
      { edge_id: 'local_fpp_e8', source_node_id: 'local_fpp_n3d', target_node_id: 'local_fpp_n4d', source_handle: 'output_1', target_handle: 'input_2', source_port: 'text', target_port: 'text', data_type: 'text' },
      // Product Image → 4 Generate nodes (ref)
      { edge_id: 'local_fpp_e4', source_node_id: 'local_fpp_n1', target_node_id: 'local_fpp_n4', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      { edge_id: 'local_fpp_e9', source_node_id: 'local_fpp_n1', target_node_id: 'local_fpp_n4b', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      { edge_id: 'local_fpp_e10', source_node_id: 'local_fpp_n1', target_node_id: 'local_fpp_n4c', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      { edge_id: 'local_fpp_e11', source_node_id: 'local_fpp_n1', target_node_id: 'local_fpp_n4d', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      // 4 Generate nodes → Download
      { edge_id: 'local_fpp_e5', source_node_id: 'local_fpp_n4', target_node_id: 'local_fpp_n5', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'media_in', data_type: 'image' },
      { edge_id: 'local_fpp_e12', source_node_id: 'local_fpp_n4b', target_node_id: 'local_fpp_n5', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'media_in', data_type: 'image' },
      { edge_id: 'local_fpp_e13', source_node_id: 'local_fpp_n4c', target_node_id: 'local_fpp_n5', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'media_in', data_type: 'image' },
      { edge_id: 'local_fpp_e14', source_node_id: 'local_fpp_n4d', target_node_id: 'local_fpp_n5', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'media_in', data_type: 'image' },
      // Avatar branch
      { edge_id: 'local_fpp_e15', source_node_id: 'local_fpp_n6', target_node_id: 'local_fpp_n8', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      { edge_id: 'local_fpp_e16', source_node_id: 'local_fpp_n1', target_node_id: 'local_fpp_n8', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'image_ref', data_type: 'image' },
      { edge_id: 'local_fpp_e17', source_node_id: 'local_fpp_n7', target_node_id: 'local_fpp_n8', source_handle: 'output_1', target_handle: 'input_2', source_port: 'text', target_port: 'text', data_type: 'text' },
      { edge_id: 'local_fpp_e18', source_node_id: 'local_fpp_n8', target_node_id: 'local_fpp_n5', source_handle: 'output_1', target_handle: 'input_1', source_port: 'media', target_port: 'media_in', data_type: 'image' },
    ],
  },
  {
    id: 'local_ugc_pose',
      ...
      try {
        ...
        for (const node of template.nodes) {
          ...
          if ((node.node_type === 'prompt' || node.type === 'prompt') && node.use_ai === true) {
            const isLoggedIn = !!(window.authManager?.isLoggedIn?.());
            if (!isLoggedIn && !window.featureGate?.canUseAiAgent?.()) {
