  ...
  },
  {
    ...
    nodes: [
      ...
      // --- AI: phân tích + viết collage prompt ---
      {
        ...
        slug: 'collage_prompt',
        slug_auto: false,
        prompt: 'Analyze this fashion garment and write a brief English description (40-60 words): fabric type and texture, precise color tone, garment style and silhouette, distinctive design details such as collar, buttons, stitching, or embellishments. Return one plain text paragraph only.',
        prompt_mode: 'all',
        use_ai: true,
        provider: 'gemini',
